...
namespace VPBot.DataObjects.Properties
{
    public static class ResourceKeys
    {
        ...
        public const string LastMessageBotStyle = "LastMessageBotStyle";

        public const string OnlyMessageUserStyle = "OnlyMessageUserStyle";
        public const string FistMessageUserStyle = "FistMessageUserStyle";
